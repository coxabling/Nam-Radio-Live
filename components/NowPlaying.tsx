...
const NowPlaying: React.FC<NowPlayingProps> = ({ liveNowPlaying }) => {
    ...
    <section className="bg-slate-900/50 backdrop-blur-xl rounded-2xl p-6 md:p-8 shadow-lg border border-slate-700/50 space-y-8">
      ...
      <div>
        ...
        <iframe
          ...
          src="https://music-station.live/public/namradio/history"
          frameBorder="0"
          allowTransparency={true}
          style={{ width: '100%', minHeight: '300px', border: 0, borderRadius: '12px' }}
        ></iframe>
      </div>
    </section>
  );
