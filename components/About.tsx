  ...
  return (
    <section className="bg-slate-900/50 backdrop-blur-xl rounded-2xl p-6 md:p-8 shadow-lg border border-slate-700/50">
      ...
      <div className="space-y-4 text-slate-300">
        <p>
          Broadcasting live from the vibrant heart of Luton, United Kingdom, Nam Radio Live is more than just a station—it's a community. Our mission is to connect diverse cultures and voices through the universal language of music, news, and shared knowledge. We believe in the power of radio to unite, inform, and inspire.
        </p>
        <p>
